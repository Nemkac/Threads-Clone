...
function useDescendant(options) {
  ...
  const [index2, setIndex] = (0, import_react5.useState)(-1);
...
function useFocusOnShow(target, options = defaultOptions) {
  ...
  const autoFocusRef = (0, import_react9.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react9.useRef)(visible);
  useSafeLayoutEffect(() => {
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react10.useRef)(null);
  const popper2 = (0, import_react10.useRef)(null);
  const instance = (0, import_react10.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react10.useRef)(() => {
  });
  const setupPopper = (0, import_react10.useCallback)(() => {
    var _a;
  ...
  const referenceRef = (0, import_react10.useCallback)(
    (node) => {
  ...
  const getReferenceProps = (0, import_react10.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react10.useCallback)(
    (node) => {
  ...
  const getPopperProps = (0, import_react10.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react10.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react10.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react13.useState)(isOpen);
  const [once, setOnce] = (0, import_react13.useState)(false);
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id3 = `${menuId}-menuitem-${(0, import_react15.useId)()}`;
...
// ../node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var useIsomorphicLayoutEffect = isBrowser2 ? import_react22.useLayoutEffect : import_react22.useEffect;
...
function useVisualElement(Component2, visualState, props, createVisualElement2) {
  ...
  const visualElementRef = (0, import_react24.useRef)();
  ...
  const canHandoff = (0, import_react24.useRef)(Boolean(window.HandoffAppearAnimations));
...
var LayoutGroupContext = (0, import_react27.createContext)({});
...
function createMotionComponent({ preloadedFeatures: preloadedFeatures2, createVisualElement: createVisualElement2, useRender, useVisualState: useVisualState2, Component: Component2 }) {
  ...
  const ForwardRefComponent = (0, import_react29.forwardRef)(MotionComponent);
...
function usePresence() {
  const context = (0, import_react35.useContext)(PresenceContext);
  if (context === null)
    return [true, null];
  const { isPresent: isPresent2, onExitComplete, register } = context;
  const id3 = (0, import_react35.useId)();
  (0, import_react35.useEffect)(() => register(id3), []);
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react38.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  return React4.createElement(React4.Fragment, null, exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react42.cloneElement)(child)));
};
...
//# sourceMappingURL=chunk-UDP5EHCG.js.map
