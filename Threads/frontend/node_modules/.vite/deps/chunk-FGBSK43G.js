...
function ColorModeProvider(props) {
  ...
  const [colorMode, rawSetColorMode] = (0, import_react4.useState)(
    () => getTheme(colorModeManager, defaultColorMode)
  );
  const [resolvedColorMode, setResolvedColorMode] = (0, import_react4.useState)(
    () => getTheme(colorModeManager)
  );
  const { getSystemTheme, setClassName, setDataset, addListener } = (0, import_react4.useMemo)(
    () => getColorModeUtils({ preventTransition: disableTransitionOnChange }),
    [disableTransitionOnChange]
  );
  const resolvedValue = initialColorMode === "system" && !colorMode ? resolvedColorMode : colorMode;
  const setColorMode = (0, import_react4.useCallback)(
    (value2) => {
...
function getOwnerWindow(node) {
  var _a2, _b;
  return isElement(node) ? (_b = (_a2 = getOwnerDocument(node)) == null ? void 0 : _a2.defaultView) != null ? _b : window : window;
}
function getOwnerDocument(node) {
  var _a2;
  return isElement(node) ? (_a2 = node.ownerDocument) != null ? _a2 : document : document;
}
...
function createContext2(options = {}) {
  ...
  function useContext4() {
    ...
    if (!context && strict) {
      ...
      (_a2 = Error.captureStackTrace) == null ? void 0 : _a2.call(Error, error2, useContext4);
      throw error2;
    }
    return context;
  }
...
function ThemeProvider2(props) {
  ...
  const computedTheme = (0, import_react14.useMemo)(() => toCSSVar(theme), [theme]);
...
//# sourceMappingURL=chunk-FGBSK43G.js.map
